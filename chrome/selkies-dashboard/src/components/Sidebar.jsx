  ...
  useEffect(() => {
    ...
    const receive = event => {
      ...
      if (message?.type === 'sasState' && typeof message.available === 'boolean' && typeof message.pending === 'boolean') {
        ...
        setSasState({ available: message.available && !message.pending && message.reason !== 'rdp_session_unsupported', pending: message.pending, reason: message.reason });
      }
